...
export function IndicadorFalhas({ data: chartData }: IndicadorFalhasChartProps) {
  ...
  const disponibilidade = calculaDisponibilidadeEquipamento({ mttr: chartData.mttr, mtbf: chartData.mtbf })
