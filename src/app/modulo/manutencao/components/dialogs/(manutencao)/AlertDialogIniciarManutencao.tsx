...
export function AlertIniciarManutencaoEquipamento({
  idManutencao,
  equipamentoId,
}: AlertIniciaManutencaoProps) {
      ...
      queryClient.setQueryData(
        ...
        listaManutencoesEquipamento?.map(manutencao => {
          if (dados.id === manutencao.id) {
            return { ...manutencao, iniciadoEm: dados.iniciadoEm, equipamentoParado: dados.equipamentoParado }
          }
          return manutencao
        })
      )
