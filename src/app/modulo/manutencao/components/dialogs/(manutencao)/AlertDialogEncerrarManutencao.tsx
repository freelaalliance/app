...
export function AlertEncerrarManutencaoEquipamento({idManutencao, equipamentoId}: AlertEncerraManutencaoProps) {
      ...
      queryClient.setQueryData(
        ...
        listaManutencoesEquipamento?.map((manutencao) => {
          if (dados.id === manutencao.id) {
            return { ...manutencao, finalizadoEm: dados.finalizadoEm, duracao: dados.duracao }
          }
          return manutencao
        })
      )
