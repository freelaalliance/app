  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          'bg-gray-900 text-white/80 hover:bg-gray-900 hover:text-white focus:bg-gray-900 focus:text-gray-50 dark:bg-gray-50 dark:text-gray-900 dark:hover:bg-gray-50 dark:hover:text-gray-900 dark:focus:bg-gray-50 dark:focus:text-gray-900',
        day_today:
